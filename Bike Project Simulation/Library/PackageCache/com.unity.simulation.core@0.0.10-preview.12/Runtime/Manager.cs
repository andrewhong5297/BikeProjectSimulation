...
namespace Unity.Simulation
{
    ...
    {
        internal const string kVersionString       = "v0.0.10-preview.12";
                ...
                if (!_finalUploadsDone)
                {
                    ...
                    try
                    {
                        ...
                        if (File.Exists(profilerLog))
                        {
                            ...
                            ConsumerFileProduced(profilerLog, true, false);
                        }
                        ...
                        if (!string.IsNullOrEmpty(Application.consoleLogPath))
                        {
                            ...
                            ConsumerFileProduced(internalLogPath, true, false);
                        }
                    }
                    catch (Exception e)
                    {
                    ...
                    if (!string.IsNullOrEmpty(_consoleLogPath))
                    {
                        foreach (var consumer in _dataConsumers)
                        {
                            if (File.Exists(_consoleLogPath))
                            {
                                ...
                                consumer.Consume(internalLogPath, true, false);
                            }
